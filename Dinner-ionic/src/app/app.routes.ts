...
const routeDefinitions: Routes = [
  ...
  { path: 'restaurants-map', loadComponent: () => import('./pages/restaurants-map/restaurants-map.page').then((m) => m.RestaurantsMapPage) },
  ...
  { path: 'table-reviews/:id', loadComponent: () => import('./pages/table-reviews/table-reviews.page').then((m) => m.TableReviewsPage) },
  ...
  { path: 'reset-password-new', loadComponent: () => import('./pages/reset-password-new/reset-password-new.page').then((m) => m.ResetPasswordNewPage) },
