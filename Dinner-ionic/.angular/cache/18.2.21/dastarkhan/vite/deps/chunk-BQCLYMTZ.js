...
var r = (t3) => {
  ...
  const W2 = t3, I = [], K = [], M2 = [], P3 = [], Y = [], Z = [], q2 = [], x = [], H = [], z = [], B2 = [], G = "function" == typeof AnimationEffect || void 0 !== d2 && "function" == typeof d2.AnimationEffect, J = "function" == typeof Element && "function" == typeof Element.prototype.animate && G, L2 = () => B2, N = (e, o) => {
    ...
    })), b2 || ie(), T && (J && (ne(0), re()), T = false), D2 && (S = Y.length + 1, D2 = false);
    const t4 = () => {
      N(i2, K), o();
    }, i2 = () => {
      N(t4, M2), o();
...
var h = (n3) => __async(void 0, null, function* () {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (yield import("./p-DWkAgceV-ZYBC4J6T.js")).iosTransitionAnimation : (yield import("./p-BsBCoGa--4IJPOHH2.js")).mdTransitionAnimation;
});
var y = (n3, e) => __async(void 0, null, function* () {
  yield k(e, true);
  const i2 = n3(e.baseEl, e);
  j(e.enteringEl, e.leavingEl);
  const a = yield C(i2, e);
  return e.progressCallback && e.progressCallback(void 0), a && D(e.enteringEl, e.leavingEl), {
    hasCompleted: a,
    animation: i2
  };
});
var P2 = (e) => __async(void 0, null, function* () {
  ...
  return yield k(e, o), j(i2, a), D(i2, a), {
    hasCompleted: true
  };
});
var k = (n3, e) => __async(void 0, null, function* () {
  (void 0 !== n3.deepWait ? n3.deepWait : e) && (yield Promise.all([B(n3.enteringEl), B(n3.leavingEl)])), yield V(n3.viewIsReady, n3.enteringEl);
});
var V = (n3, e) => __async(void 0, null, function* () {
  n3 && (yield n3(e));
});
var C = (n3, e) => {
...
@ionic/core/components/p-A3O24YmY.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BQCLYMTZ.js.map
