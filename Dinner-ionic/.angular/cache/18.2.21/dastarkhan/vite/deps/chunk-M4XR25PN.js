...
var r2 = (o, s2, e2, r3, i2, l2, f, p, d) => {
  ...
  const w = a(r3).querySelector("ion-icon").getBoundingClientRect(), k = s2 ? w.width / 2 - (w.right - i2.right) + "px" : i2.left - w.width / 2 + "px", T = s2 ? `-${window.innerWidth - i2.right}px` : `${i2.left}px`, A = `${d.top}px`, j = `${i2.top}px`, O = e2 ? [{
    offset: 0,
    ...
    opacity: 1,
    transform: "scale(1)"
  }], N = r(), S = r(), Y = r(), z = n("ion-back-button"), C = a(z).querySelector(".button-text"), R = a(z).querySelector("ion-icon");
  z.text = r3.text, z.mode = r3.mode, z.icon = r3.icon, z.color = r3.color, z.disabled = r3.disabled, z.style.setProperty("display", "block"), z.style.setProperty("position", "fixed"), S.addElement(R), N.addElement(C), Y.addElement(z), Y.beforeStyles({
    position: "absolute",
    top: "0px",
    [X]: "0px"
  }).beforeAddWrite(() => {
  ...
  }).keyframes(O), N.beforeStyles({
    "transform-origin": `${b} top`
  }).keyframes(B), S.beforeStyles({
    "transform-origin": `${y} center`
  }).keyframes(I), o.addAnimation([N, S, Y]);
};
var i = (o, a2, s2, e2, r3, i2, l2, f, p) => {
  ...
  const h = l2.top + l2.height / 2 - r3.height * X / 2 + "px", g = s2 ? [{
    ...
    offset: 1,
    opacity: 1,
    transform: `translate3d(0px, ${b}, 0) ${x}`
  }] : [{
    offset: 0,
    opacity: 0.99,
    transform: `translate3d(0px, ${b}, 0) ${x}`
...
@ionic/core/components/p-DWkAgceV.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-M4XR25PN.js.map
